  ...
  return (
    ...
    {subpage === 'home' && 
       (<>
        ...
        <button onClick={() => setSubpage('calender')} className='btn btn-accent py-8 w-full  text-xl rounded-xl  '> See Cultural Events !!!</button>
    ...
    {subpage === 'calender' && (
        ...
        <div className="navbar bg-base-100 shadow-sm fixed top-0 left-0 w-full z-50  ">
          ...
          <h1 className="text-5xl font-bold">Calender</h1>
        </div>
